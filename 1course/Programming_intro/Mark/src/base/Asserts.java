...
public class Asserts {
    ...
    public static void assertEquals(final String message, final Object expected, final Object actual) {
        assertTrue(String.format("%s: expected `%s`, actual `%s`", message, expected, actual), Objects.equals(expected, actual));
    }
    ...
    public static void assertEquals(final String message, final List<String> expected, final List<String> actual) {
        ...
        assertEquals(message + ": Number of lines", expected.size(), actual.size());
    }
